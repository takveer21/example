                                ...
                                <div class="product-inner">
                                    ...
                                    <form action="{{url('/add-to-cart')}}" method="post" class="cart">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input type="hidden" value="{{$img}}" name="product_image">
                                            <input type="hidden" value="@if ($product->discount_price){{$product->discount_price}}@else{{$product->regular_price}} @endif" name="product_price">
                                        </div>
                                        <button class="add_to_cart_button" type="submit">Add to cart</button>
                                    </form>

                                    <div class="product-inner-category">
                                        <p>Category: <a href="">{{$product->category->category_name}}</a>. Tags: {{$product->tags}}</p>
                                    </div>
